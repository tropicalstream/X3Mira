 ...
 *        /sdcard/Android/data/com.x3mira.app/files/gemini_api_key.txt
 *
 *   2. Broadcast (persisted to SharedPreferences):
 *      adb shell am broadcast -a com.x3mira.app.SET_API_KEY \
 *        --es key "AIza..."
 *
...
/** Receiver for `adb shell am broadcast -a com.x3mira.app.SET_API_KEY --es key ...` */
class ApiKeyBroadcastReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action != "com.x3mira.app.SET_API_KEY") return
